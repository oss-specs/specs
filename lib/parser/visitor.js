...
module.exports = function Visitor() {
  ...
  return {
    ...
    feature: function(keyword, name, description, line) {
      ...
      features.push(featureFactory(keyword, name, description, line, featureTags, featureComments));
    },
    ...
    scenario: function(keyword, name, description, line) {
      ...
      feature.addScenario(keyword, name, description, line, scenarioTags, scenarioComments);
    },
