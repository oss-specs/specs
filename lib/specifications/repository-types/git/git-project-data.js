...
var getNameAndPath = require('./git-name-and-path').getNameAndPath;

var getAllFiles = require('./git-files').getAllFiles;

var getCommitByName = require('./git-refs').getCommitByName;
var getBranch = require('./git-refs').getBranch;
