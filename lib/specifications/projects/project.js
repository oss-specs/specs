...
var _getFileContents = require('../files/get-contents');
...
function getFileContents(projectData, filePath) {
  return _getFileContents(projectData, filePath)
    .then(sanitiseFileList);
}
...
function addProjectConfig(projectData) {
  ...
  return _getFileContents(projectData, projectConfig.getConfigFilePath())
